...
public class NetworkPlayerSpawnVR : MonoBehaviourPunCallbacks
{
    ...
    {
        base.OnJoinedRoom();
        spawnedPlayerPrefab = PhotonNetwork.Instantiate("PoloBones", transform.position, transform.rotation);
